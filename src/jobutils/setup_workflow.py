...
def install_user_wrappers(
    ...
    if platform_name == "windows":
        ...
        specs = {
            ...
            "jobutils-vim": '@echo off\r\n@rem Generated by job-utils setup.\r\nset "PYTHONPATH={};%PYTHONPATH%"\r\n{}where vim >nul 2>nul || (echo jobutils-vim: Vim was not found 1>&2 & exit /b 127)\r\nif "%~1"=="" (\r\n  if defined JOBUTILS_CONFIGURED_GTD_ROOT if exist "%JOBUTILS_CONFIGURED_GTD_ROOT%\\gtd.md" set "JOBUTILS_GTD=%JOBUTILS_CONFIGURED_GTD_ROOT%\\gtd.md"\r\n  if not defined JOBUTILS_GTD if defined GTD_ROOT if exist "%GTD_ROOT%\\gtd.md" set "JOBUTILS_GTD=%GTD_ROOT%\\gtd.md"\r\n  if not defined JOBUTILS_GTD if exist "gtd.md" set "JOBUTILS_GTD=%CD%\\gtd.md"\r\n)\r\nif defined JOBUTILS_GTD (vim "%JOBUTILS_GTD%") else (vim %*)\r\n'.format(source_path, configured_line),
        }
        paths = {}
